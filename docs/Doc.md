...
1. Added other files with program for calculate area and perimeter.
2. Used commits and push for secure our project.
3. After all,merge main branch with other branch and pull request.
